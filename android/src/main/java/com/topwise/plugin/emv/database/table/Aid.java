...
import com.topwise.plugin.emv.database.BaseModel;
import com.topwise.plugin.emv.database.Column;
import com.topwise.plugin.emv.database.Table;
...
public class Aid extends BaseModel {
    ...
    private byte[] selFlag = new byte[1];
    @Column(name = "priority",style = "0,1")
    private byte[] priority = new byte[1];
    @Column(name = "targetPer",style = "0,1")
    private byte[] targetPer = new byte[1];
    @Column(name = "maxTargetPer",style = "0,1")
    private byte[] maxTargetPer = new byte[1];
    ...
    @Column(name = "transCurrExp",style = "0,1")
    private byte[] transCurrExp = new byte[1];
    @Column(name = "referCurrCode",style = "0,2")
    private byte[] referCurrCode = new byte[0];
    @Column(name = "referCurrExp",style = "0,1")
    private byte[] referCurrExp = new byte[1];
    ...
    @Column(name = "isAllowOnlinePIN")
    private boolean isAllowOnlinePIN = true;
    @Column(name = "kernelType",style = "0,1")
    private byte[] kernelType = new byte[1];
    @Column(name = "reserved",style = "0,1")
    ...
    public void fromTlvList(TlvList tlvList) {
        ...
        if (tlv != null) {
            ...
            Log.d(TAG, "getFloorLimit(): " + getFloorLimit());
        }
    ...
    public TlvList getTlvList(){
        ...
        tlvList.addTlv("DF01",selFlag);
        tlvList.addTlv("DF17",targetPer);
        tlvList.addTlv("DF16",maxTargetPer);
        ...
        tlvList.addTlv("5F36",transCurrExp);
        tlvList.addTlv("9F3C",referCurrCode);
        tlvList.addTlv("9F3D",referCurrExp);
    ...
    public byte getSelFlag() {
        return this.selFlag[0];
    }

    public void setSelFlag(byte selFlag) {
        this.selFlag[0] = selFlag;
    }
    ...
    public void setMaxTargetPer(byte maxTargetPer) {
        this.maxTargetPer[0] = maxTargetPer;
    }
    ...
    public byte getTransCurrExp() {
        return this.transCurrExp[0];
    }

    public void setTransCurrExp(byte transCurrExp) {
        this.transCurrExp[0] = transCurrExp;
    }
    ...
    public byte getReferCurrExp() {
        return this.referCurrExp[0];
    }

    public void setReferCurrExp(byte referCurrExp) {
        this.referCurrExp[0] = referCurrExp;
    }
    ...
    public byte getKernelType() {
        return this.kernelType[0];
    }

    public void setKernelType(byte kernelType) {
        this.kernelType[0] = kernelType;
    }
