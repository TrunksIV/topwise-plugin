...
class PayDataUtil {
    ...
    static final byte KERNTYPE_MIR = 0x13;
    ...
    class CardCode {
        ...
        static final String OFFPIN_TIMES = "offpin_times";
         ...
         * trans type
         */
        static final byte CONSUME = 0x00;
        static final byte BALANCE = 0x31;
        static final byte PREAUTH = 0x03;
        static final byte REVOKE = 0x20;
        static final byte ACCOUNT_DEPOSIT = 0x60;
        static final byte UNACCOUNT_DEPOSIT = 0x62;
        static final byte CASH_DEPOSIT = 0x63;
        static final byte CASH_REVOKE = 0x17;
        static final byte UNLOOP_CARD = (byte) 0xF1;
        static final byte OFF_BALANCE = (byte) 0xF2;
        static final byte TRANS_LOG = (byte) 0xF3;
        static final byte TRAP_LOG = (byte) 0xF4;
        ...
        static final byte TRANS_APDU_EXCHANGE_ERROR = 0x07;
        ...
        static final byte TRANS_CANCEL = (byte)0xFF;
    }
    ...
    String getSequenceCounter() {
        ...
        Log.d(TAG, "sequence counter: " + buffer);
        return buffer;
    }
    ...
    String getTransDateTime(int type) {
        ...
        Log.d(TAG, "getTransDateTime: " + result);
        return result;
    }
    ...
    TlvList getDefaultKernal() {
        ...
        list.addTlv("DF8117","E0");
        list.addTlv("DF8118","F1");
        list.addTlv("DF8119","F1");
        list.addTlv("DF811F","08");
        list.addTlv("DF811A","9F6A04");
        list.addTlv("DF811B","30");
        list.addTlv("DF811E","10");
        list.addTlv("DF812C","00");
        list.addTlv("9F6D","C0");
        list.addTlv("9F35","22");
        list.addTlv("DF81","0102");
        list.addTlv("5F2A","0840");
        list.addTlv("9F1A","0840");
